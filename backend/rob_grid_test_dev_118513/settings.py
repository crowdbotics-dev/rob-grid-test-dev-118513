"""
Django settings for rob_grid_test_dev_118513 project.
...
ROOT_URLCONF = 'rob_grid_test_dev_118513.urls'
...
WSGI_APPLICATION = 'rob_grid_test_dev_118513.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rob_grid_test_dev_118513 API",
    "DESCRIPTION": "API documentation for rob_grid_test_dev_118513 App",
    "VERSION": "v1",
}
